# Claude Fable 5 — a field note

An independent, fact-checked explainer on **Claude Fable 5**, the Anthropic model released publicly on **June 9, 2026** — its first publicly available Mythos-class model and the first in the Claude 5 line.

**→ Read it: https://gerardordz96.github.io/claude-fable-5/**

Covers what it is, how it relates to Mythos 5 and Project Glasswing, the fallback-to-Opus-4.8 safety architecture, the (vendor-reported) benchmarks, pricing vs. Opus 4.8, availability and the June 22 free-window cliff, and what it changes for engineering teams.
